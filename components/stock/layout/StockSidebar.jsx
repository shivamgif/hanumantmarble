...
function SidebarNavItem({ Icon, Label, Href, IsActive }) {
  return (
    <Link
      ...
      title={Label}
      aria-label={Label}
      className={`group flex items-center gap-3 rounded-xl px-4 py-3.5 transition-colors duration-200 focus-ring ${
        IsActive
    ...
    >
      ...
      {IsActive && (
        <div className="ml-auto w-1 h-4 rounded-full bg-brand-primary" />
      )}
    </Link>
  );
}
        ...
        <div className="p-4 rounded-2xl bg-muted/40 border border-border/60 space-y-4">
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex-1 h-10 flex items-center justify-center gap-2 rounded-xl border border-border bg-card text-[10px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-300 transition-all hover:border-brand-primary/30 hover:text-brand-primary active:scale-95 focus-ring"
            >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className="relative h-10 w-10 flex items-center justify-center rounded-xl border border-border bg-card text-slate-600 dark:text-slate-300 transition-all hover:border-brand-primary/30 hover:text-brand-primary active:scale-95 focus-ring"
                >
            ...
            <button
              ...
              className="h-10 w-10 flex items-center justify-center rounded-xl border border-border bg-card text-slate-600 dark:text-slate-300 transition-all hover:border-brand-primary/30 hover:text-brand-primary active:scale-95 focus-ring"
            >
              {isDarkTheme ? <SunMedium className="h-4 w-4" /> : <MoonStar className="h-4 w-4" />}
            </button>
          </div>

          <div className="flex items-center gap-3 p-3 rounded-xl bg-card border border-border/60 shadow-card">
