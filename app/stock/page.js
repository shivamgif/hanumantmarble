...
/**
 * Stock Management Dashboard - Main entry point for internal system
 */
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-2 text-gray-600">
          Welcome to the stock management system. Use the menu below to manage inventory.
        </p>
      </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition cursor-pointer">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">View and manage stock levels</p>
              </div>
            </div>
          </div>
        </Link>
          ...
          <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition cursor-pointer">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">Track all inventory changes</p>
              </div>
            </div>
          </div>
        </Link>
          ...
          <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition cursor-pointer">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">Generate stock reports</p>
              </div>
            </div>
          </div>
        </Link>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm font-medium text-red-800">
              This system is for internal use only. Unauthorized access is prohibited.
            </p>
          </div>
        </div>
      </div>
