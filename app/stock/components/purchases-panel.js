...
import { createBagArrivalItemRow, createInitialBagArrivalDraft, formatDateTime, getGeneratedByRoleLabel, getStatusVariant, CLASSES, FORM_INPUT_CLASS, toNumber, trimText, fetchShipmentDetails, invalidateShipmentCache, exportToCSV } from '../lib/stock-utils';
      ...
      <div className="mb-6 flex items-center justify-end gap-3">
        <button
          ...
          onClick={() => {
            ...
            exportToCSV(`Purchases_Export_${dateStr}.csv`, arrivalPagination.allRows, columns);
          }}
