...
import { formatDateTime, getGeneratedByRoleLabel, getStatusVariant, CLASSES, FORM_INPUT_CLASS, exportToCSV } from '../lib/stock-utils';
      ...
      <div className="mb-6 flex items-center justify-end gap-3">
        <button
          ...
          onClick={() => {
            ...
            exportToCSV(`Dispatches_Export_${dateStr}.csv`, dispatchPagination.allRows, columns);
          }}
