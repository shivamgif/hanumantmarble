...
export const auth = betterAuth({
  ...
  // No stock_app_users provisioning hook on signup: GET /api/stock/access creates the
  // row as 'stock_maintainer' + 'inactive' on first visit. Two writers racing on the
  // same ON CONFLICT (email) row meant whichever won decided the new user's role.
});
