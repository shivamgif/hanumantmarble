...
-- Inbound purchase cost and measurement adjustments (2026-04-19)
ALTER TABLE IF EXISTS stock_inbound_shipments ADD COLUMN IF NOT EXISTS handling_cost_percent NUMERIC(5, 2) NOT NULL DEFAULT 1.0;
ALTER TABLE IF EXISTS stock_inbound_shipments ADD COLUMN IF NOT EXISTS fuel_cost_percent NUMERIC(5, 2) NOT NULL DEFAULT 5.0;
ALTER TABLE IF EXISTS stock_inbound_shipments ADD COLUMN IF NOT EXISTS gst_percent NUMERIC(5, 2) NOT NULL DEFAULT 18.0;
ALTER TABLE IF EXISTS stock_inbound_shipments ADD COLUMN IF NOT EXISTS grand_total NUMERIC(14, 2) NOT NULL DEFAULT 0;
ALTER TABLE IF EXISTS stock_inbound_shipments ADD COLUMN IF NOT EXISTS freight_weight_kg NUMERIC(12, 3);

ALTER TABLE IF EXISTS stock_inbound_shipment_items ADD COLUMN IF NOT EXISTS whole_qty_sqm NUMERIC(14, 3);
